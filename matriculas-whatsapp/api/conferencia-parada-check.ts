...
// Verificação de baias paradas na Conferência Digital: quem abriu uma baia
// e não terminou em 5 minutos recebe um WhatsApp perguntando se já
// finalizou. Chamado por cron (Vercel Cron / agendador externo) — sem
// gatilho oportunista, já que não existe um "grupo" recebendo mensagens
// pra essa verificação piggybackar (diferente do lembrete de Frota Leve).
//
...
import { verificarLembretesConferenciaParada } from './zapi-webhook'
