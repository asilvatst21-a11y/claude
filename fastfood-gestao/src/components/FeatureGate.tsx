    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-gray-500 mb-2">
          Disponível a partir do plano <span className="font-bold text-orange-600">{PLAN_LABELS[requiredPlan]}</span>.
        </p>
        ...
        <Link
          to="/planos"
          target="_blank"
          className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors shadow-md"
        >
          Fazer upgrade →
        </Link>
      </div>
